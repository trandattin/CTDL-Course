...
bool compareLinkList(LinkList L1, LinkList L2)
{
	if (isEmpty(L1) && isEmpty(L2))
		return true;
	if (isEmpty(L1) || isEmpty(L2))
		return false;
	NodePointer cur_node_L1 = L1.Head;
	NodePointer cur_node_L2 = L2.Head;
	while((cur_node_L1 != NULL) && (cur_node_L2 != NULL))
	{
